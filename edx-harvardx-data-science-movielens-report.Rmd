...
I want to note before moving on that the median of all the ratings across all reviews in the MovieLens[@MovieLens] data is greater than the mean of all the ratings. This means that the ratings (out of 5 stars) have a left skew, which can also be represented visually with this plot.
