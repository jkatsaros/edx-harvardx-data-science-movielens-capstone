...
Peeking at the `edx` data set, we can see that there are 69,878 users who reviewed 10,677 movies with six different features I can use to make predictions on: The unique identifier of a user who made a movie review with MovieLens[@MovieLens] `(userId)`, the unique identifier of a movie within MovieLens `(movieId)`, the rating the user gave the movie (out of 5 stars, `rating`), a time stamp of when the user made the movie review (`timestamp`), the title of the movie the user reviewed (`title`), and the genres the movie belongs to within MovieLens[@MovieLens] (separated by `|`, `genres`).
